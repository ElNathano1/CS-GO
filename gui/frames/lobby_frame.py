...
class LobbyFrame(ttk.Frame):
    ...
    def _build_step_2(self) -> None:
        ...
        title = tk.Canvas(
            self,
            width=self.app.S(600),
            height=self.app.S(182),
            relief=tk.FLAT,
            bd=0,
    ...
    def _build_step_3(self) -> None:
        ...
        main_menu_frame.pack(pady=self.app.S(20), padx=self.app.S(30))
        self._menu_frame = self.app.Frame(main_menu_frame)
        self._menu_frame.pack(pady=self.app.S(3), padx=self.app.S(3))
    ...
    def _build_local_button(self) -> None:
        self.app.Button(
            ...
            takefocus=False,
        ).pack(pady=self.app.S((20, 10)), fill=tk.X, padx=self.app.S(30))
    ...
    def _build_online_button(self) -> None:
        ...
        self.online_button.pack(pady=self.app.S(10), fill=tk.X, padx=self.app.S(30))
    ...
    def _build_settings_button(self) -> None:
        self.app.Button(
            ...
            takefocus=False,
        ).pack(pady=self.app.S(10), fill=tk.X, padx=self.app.S(30))
    ...
    def _build_return_button(self) -> None:
        self.app.Button(
            ...
            takefocus=False,
        ).pack(pady=self.app.S((10, 20)), fill=tk.X, padx=self.app.S(30))
